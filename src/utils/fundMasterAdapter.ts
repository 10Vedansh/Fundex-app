...
export function toMutualFund(row: FundMasterRow): MutualFund {
  ...
  return {
    ...
    expenseRatio: row.expense_ratio ?? null,
    cagr1Y: row.cagr_1y != null ? row.cagr_1y * 100 : null,
    cagr3Y: row.cagr_3y != null ? row.cagr_3y * 100 : null,
    cagr5Y: row.cagr_5y != null ? row.cagr_5y * 100 : null,
    volatility:
      row.volatility_3y != null ? row.volatility_3y * 100 :
      row.volatility_1y != null ? row.volatility_1y * 100 :
      row.std_dev ?? null,
    sharpeRatio: row.sharpe_ratio_3y ?? row.sharpe_ratio_1y ?? null,
    beta: row.beta ?? null,
    ...
    ret1W: row.ret_1w != null ? row.ret_1w * 100 : null,
    ret1M: row.return_1m != null ? row.return_1m * 100 : null,
    ret3M: row.return_3m != null ? row.return_3m * 100 : null,
    ret6M: row.return_6m != null ? row.return_6m * 100 : null,
    ret1Y: row.ret_1y_overall != null ? row.ret_1y_overall * 100 : (row.cagr_1y != null ? row.cagr_1y * 100 : null),
    ret3Y: row.ret_3y_overall != null ? row.ret_3y_overall * 100 : (row.cagr_3y != null ? row.cagr_3y * 100 : null),
    ret5Y: row.ret_5y_overall != null ? row.ret_5y_overall * 100 : (row.cagr_5y != null ? row.cagr_5y * 100 : null),
    ret10Y: row.ret_10y_overall != null ? row.ret_10y_overall * 100 : null,
